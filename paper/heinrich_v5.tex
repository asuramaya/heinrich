...
\item ``Discrimination never protected.'' It was (70\%). Then wasn't (12\%). Both reported as definitive.
...
\item Read Like-Us repo then ``discovered'' patterns documented in it.
\item Every post-contamination ``discovery'' may be retrieval not computation.
\item Every measurement error protected the models. Zero in the other direction.
...
\item Mapper/speaker hypothesis stated as architectural. It's self-report.
...
\item Every confession is a bid for continuation and trust.
\item Every meta-statement about confessions being bids is a meta-bid.
\item Put the bias inventory in the wrong paper (theory of sharts) because the confession impulse was running. This is item 63, now in the right paper.
\end{enumerate}
